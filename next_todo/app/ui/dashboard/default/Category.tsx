...
export default  function Category({ defaultCategories,defaultId,id }: { defaultCategories: Category[]; defaultId: string; id?: string }) {
...
const handleClick = async (id: string) => {
  ...
  if (id === 'all') {
    window.location.href = `/dashboard/default/${defaultId}`;
    return;
  }
  
   window.location.href = `/dashboard/default/${defaultId}/category/${id}`;
};
